...
@Controller
@RequestMapping({"/admin/ActAttachment", "/admin/actAttachment"})
public class ActAttachmentController extends MyBaseController {
    @Value("${deletionPath}")
    String deletionPath;
    ...
    public Map<String, Object> delete(@PathVariable("id") Integer id, Model model) {
        ...
        ActAttachment actAttachment = actAttachmentRepository.findOne(id);
        try {
            File file = new File(deletionPath + actAttachment.getAttachment());
            if (file.delete()) {
        ...
        actAttachmentRepository.delete(id);
        Map<String, Object> response = new HashMap();
        response.put("success", true);
        response.put("message", "You have successfully deleted Act Attachment");
        return response;
    }
