...
@Entity
@Table(name="ChapterNameFootnote")
//@EqualsAndHashCode
//@ToString
public class ChapterNameFootnoteForActChapter implements Serializable{
    ...
    public ChapterNameFootnoteForActChapter() {
        super();
    }
