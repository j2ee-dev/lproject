...
@Entity
@Table(name="SectionDescriptionFootnote")
@EqualsAndHashCode
@ToString
public class SectionDescriptionFootnoteForActSection implements Serializable{
    ...
    public SectionDescriptionFootnoteForActSection() {
        super();
    }
