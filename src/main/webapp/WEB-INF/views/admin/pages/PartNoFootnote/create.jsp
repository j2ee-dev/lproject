...
<div class="panel panel-success">
    ...
    <div class="panel-heading  text-center text-primary">Part No Footnote<span class="pull-right"><a href="#PartNoFootnote/index" role="button"> <i class="fa fa-history" aria-hidden="true"></i>
Back to List</a></span></div>
    <div class="panel-body">
		<form:form method="post" role="form" modelAttribute="partNoFootnote" action="${contextPath}/admin/partNoFootnote${action}?${_csrf.parameterName}=${_csrf.token}" class="form-horizontal" data-validation="true" data-ajax-submit="true" novalidate="novalidate">
		    <spring:bind path="partId.id">
       	        	<div class="form-group ${(not empty status.errorMessage) ? ' has-error':''}">
				    	<label for="inputpartId.id" class="col-sm-2 control-label">Part</label>
				    	<div class="col-sm-9">
				      		<form:select class="form-control"  data-selected="${partNoFootnote.partId.id}" data-itemLabel="partNo" data-itemValue="id" data-validation="trim|is_exist[ActPart.id]|integer" path="partId.id" id="inputpartId.id">
		    ...
		    <div class="form-group">
		        <div class="col-sm-offset-4 col-sm-5">
		            ...
		            <a href="#PartNoFootnote/index" role="button" class="btn btn-warning">Cancel</a> 
		        </div>
		    </div>
		</form:form>
	</div>
