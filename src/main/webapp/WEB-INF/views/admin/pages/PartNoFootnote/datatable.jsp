    ...
    <!-- Default panel contents -->
 	<div class="panel-heading text-center text-primary">
 		...
 		<span class="pull-right">
 			<a href="#PartNoFootnote/create/${rand}" role="button">
    ...
    <div class="panel-body">
  		<div class="table-responsive">
			<table id="datatable_for_partNoFootnote" class="datatable table table-striped table-bordered dt-responsive nowrap compact stripe"
				...
				data-scrollY="&quot;200px&quot;"
				data-searching="true"
				data-ajax-url="<c:url value="/admin/partNoFootnote/data?${_csrf.parameterName}=${_csrf.token}"/>"
				...
				width="100%"
				data-columns-sequence="index,partId.partNo,footnoteNumber,footnoteSign,status,action"
			>
				<thead>
					<th name="index" value="" type="index" data-priority="1" data-visible="false" data-orderable="false" data-searchable="false">SL No</th>
						<th name="partId.partNo" value="partId.partNo" data-priority="3">Part</th>
					...
					<th name="action" value="id" data-edit="true" data-delete="true" data-view="true" data-delete-url="admin/partNoFootnote/delete/:id" data-edit-url="admin#partNoFootnote/edit/:id" data-view-url="admin#partNoFootnote/details/:id" data-view-button-class="btn btn-primary btn-sm" data-edit-button-class="btn btn-info btn-sm" data-delete-button-class="btn btn-danger btn-sm" data-view-icon-class="fa fa-info-circle" data-edit-icon-class="" data-delete-icon-class="fa fa-trash" data-notexport="true" data-orderable="false" data-searchable="false" data-priority="2">Action</th>
				</thead>
			</table>
		</div>
