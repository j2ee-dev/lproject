...
Back to List</a>
    ...
    <div class="panel-body table-responsive">
        <table class="table table-condensed">
					...
					<tr class="">
					<th style="white-space: nowrap;">Hit Date</th>
					<th style="white-space:nowrap;width:1px;"> : </th>
					<td>${hit.hitDate}</td>
					</tr>
				
					<tr class="active">
					<th style="white-space: nowrap;">Hit Numbers</th>
					<th style="white-space:nowrap;width:1px;"> : </th>
					<td>${hit.hitNumbers}</td>
					</tr>
				
					<tr class="">
					<th style="white-space: nowrap;">Refresh Hits</th>
					<th style="white-space:nowrap;width:1px;"> : </th>
					<td>${hit.refreshHits}</td>
					</tr>
