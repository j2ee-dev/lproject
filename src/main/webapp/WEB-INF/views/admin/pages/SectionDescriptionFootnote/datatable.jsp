...
<div class="panel panel-success">
    <!-- Default panel contents -->
 	<div class="panel-heading text-center text-primary">
 		Section Description Footnote
 		<span class="pull-right">
 			<a href="#SectionDescriptionFootnote/create/${rand}" role="button">
    ...
    <div class="panel-body">
  		<div class="table-responsive">
			<table id="datatable_for_sectionDescriptionFootnote" class="datatable table table-striped table-bordered dt-responsive nowrap compact stripe"
				...
				data-scrollY="&quot;200px&quot;"
				data-searching="true"
				data-ajax-url="<c:url value="/admin/sectionDescriptionFootnote/data?${_csrf.parameterName}=${_csrf.token}"/>"
