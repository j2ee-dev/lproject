...
<div class="panel panel-success">
    ...
    <div class="panel-heading text-center text-primary">Static Page<span class="pull-right"><span class="pull-right"><a href="#StaticPage/create" role="button"><i class="fa fa-arrow-right"></i>Create New</a></span><span class="pull-right"><a href="#StaticPage/edit/${id}" role="button"><i class="fa fa-arrow-right"></i> Edit</a></span><%--<a href="#StaticPage/edit/${id}" role="button"><i class="fa fa-arrow-right"></i> Edit</a></span>--%>
