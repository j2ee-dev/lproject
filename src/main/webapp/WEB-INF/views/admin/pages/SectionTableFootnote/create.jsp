...
<div class="panel panel-success">
    ...
    <div class="panel-heading  text-center text-primary">Section Table Footnote<span class="pull-right"><a href="#SectionTableFootnote/index" role="button"> <i class="fa fa-history" aria-hidden="true"></i>
Back to List</a></span></div>
    <div class="panel-body">
		<form:form method="post" role="form" modelAttribute="sectionTableFootnote" action="${contextPath}/admin/sectionTableFootnote${action}?${_csrf.parameterName}=${_csrf.token}" class="form-horizontal" data-validation="true" data-ajax-submit="true" novalidate="novalidate">
		    <spring:bind path="sectionId.id">
       	        	<div class="form-group ${(not empty status.errorMessage) ? ' has-error':''}">
				    	<label for="inputsectionId.id" class="col-sm-2 control-label">Section</label>
				    	<div class="col-sm-9">
				      		<form:select class="form-control"  data-selected="${sectionTableFootnote.sectionId.id}" data-itemLabel="sectionName" data-itemValue="id" data-validation="trim|is_exist[ActSection.id]|integer" path="sectionId.id" id="inputsectionId.id">
		    ...
		    <div class="form-group">
		        <div class="col-sm-offset-4 col-sm-5">
		            ...
		            <a href="#SectionTableFootnote/index" role="button" class="btn btn-warning">Cancel</a> 
		        </div>
		    </div>
		</form:form>
	</div>
