    ...
    <!-- Default panel contents -->
 	<div class="panel-heading text-center text-primary">
 		...
 		<span class="pull-right">
 			<a href="#ActChapter/create" role="button">
    ...
    <div class="panel-body">
  		<div class="table-responsive">
			<table id="datatable_for_actChapter" class="datatable table table-striped table-bordered dt-responsive nowrap compact stripe"
				...
				data-scrollY="&quot;200px&quot;"
				data-searching="true"
				data-ajax-url="<c:url value="/admin/actChapter/data?${_csrf.parameterName}=${_csrf.token}"/>"
				...
				width="100%"
				data-columns-sequence="index,id,volume.volumeName,actId.shortTitle,partId.partNo,chapterNo,chapterName,chapterOrder,attachment,status,action"
			>
				<thead>
					<th name="index" value="" type="index" data-priority="1" data-visible="false" data-orderable="false" data-searchable="false">SL No</th>
					<th name="id" value="id" data-priority="3">Act Chapter ID</th>
					...
					<th name="chapterNo" value="chapterNo" data-priority="7">Chapter No</th>
					<th name="chapterName" value="chapterName" data-priority="8">Chapter Name</th>
					<th name="chapterOrder" value="chapterOrder" data-priority="9">Chapter Order</th>
					<th name="attachment" value="attachment" data-priority="10">Attachment</th>
					<th name="status" value="status" data-priority="11">Status</th>
				
					<th name="action" value="id" data-edit="true" data-delete="true" data-view="true" data-delete-url="admin/actChapter/delete/:id" data-edit-url="admin#actChapter/edit/:id" data-view-url="admin#actChapter/details/:id" data-view-button-class="btn btn-primary btn-sm" data-edit-button-class="btn btn-info btn-sm" data-delete-button-class="btn btn-danger btn-sm" data-view-icon-class="fa fa-info-circle" data-edit-icon-class="" data-delete-icon-class="fa fa-trash" data-notexport="true" data-orderable="false" data-searchable="false" data-priority="2">Action</th>
				</thead>
			</table>
		</div>
