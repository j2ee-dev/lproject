...
<div class="form-group">
    ...
    <div class="col-sm-10 child_information">
        <button type="button" class="btn btn-info add_child_row"
                data-child-validation="required|min_row[1]|max_row[3]|exact_row[3]">Edit Act Gazzeted Copy
        </button>
                ...
                <td>
                    <div class="checkbox-inline">
                        <form:checkbox data-validation="trim"
                                       path="actScheduleList1[0].status" value="1"/> Status
                    </div>
                </td>
                <td>
