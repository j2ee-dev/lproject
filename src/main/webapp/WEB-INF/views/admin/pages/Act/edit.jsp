            ...
            <spring:bind path="volume.id">
                <div class="form-group ${(not empty status.errorMessage) ? ' has-error':''}">
                    ...
                    <div class="col-sm-9" style="width: 973px;">
                        <form:select class="form-control selectpicker" data-selected="${act.volume.id}" data-itemLabel="volumeName"
                                     data-live-search="true" data-itemValue="id" data-validation="trim|is_exist[Volume.id]|integer"
