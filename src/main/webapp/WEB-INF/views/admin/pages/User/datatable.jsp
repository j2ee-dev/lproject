    ...
    <div class="panel-body">
  		<div class="table-responsive">
			<table id="datatable_for_user" class="datatable table table-striped table-bordered dt-responsive nowrap compact stripe"
				...
				width="100%"
				data-columns-sequence="index,username,fullName,designation,phone,email,action"
			>
				<thead>
					...
					<th name="fullName" value="fullName" data-priority="4">Full Name</th>
					<th name="designation" value="designation" data-priority="6">Designation</th>
					<th name="phone" value="phone" data-priority="5">Phone</th>
					<th name="email" value="email" data-priority="6">Email</th>
