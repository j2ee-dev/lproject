...
<div class="panel panel-success">
    ...
    <div class="panel-heading text-center text-primary">User<span class="pull-right"><a href="#User/create" role="button"><i class="fa fa-arrow-right"></i> Create New</a></span></div>
