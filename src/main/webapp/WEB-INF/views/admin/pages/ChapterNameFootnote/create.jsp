...
<div class="panel panel-success">
    ...
    <div class="panel-heading  text-center text-primary">Chapter Name Footnote<span class="pull-right"><a href="#ChapterNameFootnote/index" role="button"> <i class="fa fa-history" aria-hidden="true"></i>
Back to List</a></span></div>
    <div class="panel-body">
		<form:form method="post" role="form" modelAttribute="chapterNameFootnote" action="${contextPath}/admin/chapterNameFootnote${action}?${_csrf.parameterName}=${_csrf.token}" class="form-horizontal" data-validation="true" data-ajax-submit="true" novalidate="novalidate">
		    <spring:bind path="chapterId.id">
       	        	<div class="form-group ${(not empty status.errorMessage) ? ' has-error':''}">
				    	<label for="inputchapterId.id" class="col-sm-2 control-label">Chapter</label>
				    	<div class="col-sm-9">
				      		<form:select class="form-control"  data-selected="${chapterNameFootnote.chapterId.id}" data-itemLabel="chapterNo" data-itemValue="id" data-validation="trim|is_exist[ActChapter.id]|integer" path="chapterId.id" id="inputchapterId.id">
    							<form:option value="0"> --SELECT--</form:option>
    							<form:options items="${actChapterList}" itemLabel="chapterNo" itemValue="id"></form:options>
  							</form:select>
		    ...
		    <div class="form-group">
		        <div class="col-sm-offset-4 col-sm-5">
		            ...
		            <a href="#ChapterNameFootnote/index" role="button" class="btn btn-warning">Cancel</a> 
		        </div>
		    </div>
		</form:form>
	</div>
