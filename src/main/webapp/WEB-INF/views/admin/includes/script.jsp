...
<script src="<c:url value="/resources/admin/assets/bootstrap/js/bootstrap-select.js"/>"></script>
...
<script type="text/javascript" src="<c:url value="/resources/admin/assets/js/angular.min1.js"/>"></script>
<script type="text/javascript" src="<c:url value="/resources/admin/assets/js/angular-route1.js"/>"></script>
