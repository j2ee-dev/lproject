...
<div class="col-md-11 boxed-layout masterContent <c:if test="${hl!=null}">searchable</c:if>" style="padding: 10px;width: 90%;" id="page-content">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-bottom12 col-md-12 col-lg-12">
                <p class="pull-left no-print">
                    <a href="/act-${act.id}/section-${sectionId}.html"><i class="fa fa-arrow-left" title="Back"
    ...
    <section
        ...
        <div class="row margin-top-20 preamble-content">
            ...
            <c:if test="${fn:containsIgnoreCase(string,'The Republic') && fn:containsIgnoreCase(act.shortTitle, 'Constitution')}">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 lineremove">
                </br> </br>
                <c:choose>
                    <c:when test="${act.isBanglaAct==false && act.displayPreambleText==true}">
