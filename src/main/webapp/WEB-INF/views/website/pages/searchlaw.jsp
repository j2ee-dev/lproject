    ...
    <div class="col-sm-6">
        <form cssClass="form-inline" action="${contextPath}/search.html">
            <div class="input-group">
                <input id="search-click" name="q" value="${fn:escapeXml(q)}" class="form-control" placeholder="<spring:message code="website.search.text"/>"/>
                ...
                <span class="input-group-btn">
                        <button class="btn-u" onclick="highlightSearch()" type="submit"><i class="fa fa-search"></i></button>
                </span>
    ...
    <div class="row  advancedSearchForm" style="display:none; margin-top:10px;padding: 10px;">
        <form:form modelAttribute="search" action="${contextPath}/search.html" method="get" class="form-inline">
            <table class="table table-striped">
                ...
                <tr>
                    <th class="text-right search-body-back-color"><spring:message code="website.sectionNo.text"/></th>
                    <td class="search-body-back-color">
                ...
                <tr>
                    <td colspan="6" class="text-center">
                        <button type="submit" class="btn btn-lg btn-primary search-click"><spring:message code="website.search.text"/></button>
                    </td>
                </tr>
            </table>
        </form:form>
...
<div id="searchtext">
    <c:choose>
        <c:when test="${results.hasContent()}">
            <div class="row well well-sm searchable">
                <c:forEach items="${results.getContent()}" var="search" varStatus="loop">
                    ...
                    <div class="result ${search.actId.repealedAct.status==true? 'repealed': ''}">
                        <h3 class="r"><a onclick="highlightSearch()" href="${contextPath}/${search.link}?hl=1">${ata:html2Text(search.actId.shortTitle)}</a></h3>
                        <div class="s">
                            <div class="resm">
