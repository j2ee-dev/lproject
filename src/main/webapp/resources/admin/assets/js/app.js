...
$(function(){
    ...
    $(document).on('change', '[data-change-pulls]', function(event) {
        /* Split the data-change-pulls params  by pipe(|) */
        var obj = this;
        var params     = $(this).attr('data-change-pulls').split("|");
        /*
         * inputs are to be pulled by filters
         */
        var inputs     = params[0].split(",");
    ...
    $("[data-change-pulls]").trigger("change");
    ...
    $(document).on('click', '.add_child_row_attachment', function(event) {
        ...
        var content = childs.getComments();
        //console.log(content[0]);
        if(index===0) {var contentString = content[0].replace(/\[0\]/g, "["+index+"]");}
        if(index===2) {var count=index-1;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===4) {var count=index-2;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===6) {var count=index-3;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===8) {var count=index-4;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===10) {var count=index-5;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===12) {var count=index-6;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===14) {var count=index-7;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===16) {var count=index-8;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===18) {var count=index-9;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===20) {var count=index-10;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===22) {var count=index-11;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===24) {var count=index-12;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===26) {var count=index-13;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===28) {var count=index-14;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===30) {var count=index-15;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===32) {var count=index-16;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===34) {var count=index-17;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===36) {var count=index-18;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===38) {var count=index-19;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===40) {var count=index-20;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===42) {var count=index-21;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===44) {var count=index-22;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===46) {var count=index-23;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===48) {var count=index-24;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===50) {var count=index-25;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===52) {var count=index-26;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===54) {var count=index-27;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===56) {var count=index-28;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===58) {var count=index-29;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        if(index===60) {var count=index-30;var contentString = content[0].replace(/\[0\]/g, "["+count+"]");}
        var contentHtml = $($.parseHTML($.trim(contentString)));
        contentHtml.find("input,select,textarea").removeAttr('value');
        contentHtml.find("input[type=checkbox]").removeAttr('checked');
...
$(function () {
    $(document).bind("childPageReload",function () {
        ...
        $(document).find("[data-change-pulls]").trigger("change");
